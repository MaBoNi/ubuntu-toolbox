...
echo -e "   View status:        ${BLUE}sudo fail2ban-client status${NC}"
echo -e "   View SSH jail:      ${BLUE}sudo fail2ban-client status sshd${NC}"
echo -e "   Unban an IP:        ${BLUE}sudo fail2ban-client set sshd unbanip <IP>${NC}"
echo -e "   View banned IPs:    ${BLUE}sudo fail2ban-client status sshd${NC}"
echo -e "   View logs:          ${BLUE}sudo tail -f /var/log/fail2ban.log${NC}"
echo ""
echo -e "${YELLOW}📄 Configuration files:${NC}"
echo -e "   Main config:        ${BLUE}/etc/fail2ban/jail.local${NC}"
echo -e "   Logs:               ${BLUE}/var/log/fail2ban.log${NC}"
echo ""
