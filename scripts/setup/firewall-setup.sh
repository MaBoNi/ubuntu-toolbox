...
echo "   View status:        ${BLUE}sudo ufw status verbose${NC}"
echo "   View numbered:      ${BLUE}sudo ufw status numbered${NC}"
echo "   Delete rule:        ${BLUE}sudo ufw delete <number>${NC}"
echo "   Allow port:         ${BLUE}sudo ufw allow <port>${NC}"
echo "   Deny port:          ${BLUE}sudo ufw deny <port>${NC}"
echo "   Disable firewall:   ${BLUE}sudo ufw disable${NC}"
echo "   Reset firewall:     ${BLUE}sudo ufw reset${NC}"
echo ""
echo -e "${YELLOW}📄 UFW logs:${NC}"
echo "   ${BLUE}/var/log/ufw.log${NC}"
echo ""
